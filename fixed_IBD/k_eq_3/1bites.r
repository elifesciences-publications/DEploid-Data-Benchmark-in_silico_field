...
breaks.at1 = 0.33*n.loci
breaks.at2 = 0.67*n.loci

new.hap1 = red_hap
new.hap2 = blue_hap
new.hap3 = red_hap

new.hap1[1:breaks.at2] = blue_hap[1:breaks.at2]
new.hap2[1:breaks.at1] = red_hap[1:breaks.at1]
...
for ( pidx in 1:length(p1_ary) ){
    ...
    system(paste("gzip alleleCount/",trueHap_prefix, "p", p1,"v", p2, "v", p3, ".ref", sep = ""))
    ...
    system(paste("gzip alleleCount/",trueHap_prefix, "p", p1,"v", p2, "v", p3, ".alt", sep = ""))
}
