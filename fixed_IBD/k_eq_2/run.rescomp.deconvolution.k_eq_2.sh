...
#echo $vv;
    ...
    run_dEploid asiaGroup1 k_eq_2 1bites_high ${vv}
    run_dEploid asiaGroup1 k_eq_2 1bites_low ${vv}
    run_dEploid africaGroup2 k_eq_2 1bites_high ${vv}
    run_dEploid africaGroup2 k_eq_2 1bites_low ${vv}
done
